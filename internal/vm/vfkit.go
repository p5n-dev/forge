...
func DefaultArgs(opts StartOptions) []string {
	...
	// and is what gives the VM full connectivity through tunnel-all
	// corp VPNs — every guest connection becomes a host-side socket
	// call (see internal/gvproxy package docs).
