...
// FORGE VMs OrbStack-equivalent network connectivity even when the
// host is on a tunnel-all corporate VPN.
//
...
// engine from any other Mac process. Same trick OrbStack/Podman
// Machine/WSL2 use.
//
// Wire shape:
//
